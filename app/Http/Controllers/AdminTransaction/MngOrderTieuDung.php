...
class MngOrderTieuDung extends Controller
{
    ...
    public function _list()
    {
        ...
        $listObj = $listObj->where(
            [
                '$or' => [
                    [ "tai_khoan_nhan.id" => $curentMemberId ],
                    [ "tai_khoan_nguon.id" => $curentMemberId ],
        ...
        $resultQuery = \DB::table(Transaction::table_name)->raw(function ($collection) use ($curentMemberId)  {
